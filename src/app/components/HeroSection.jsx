  ...
  return (
    <div className='flex flex-col md:flex-row'>
      <div className='w-full md:h-72 lg:h-[22rem] pt-14 pb-4 flex px-4 lg:px-12 flex-col justify-center'>
        <h1 className='uppercase tracking-wide font-bold text-neutral-600 text-4xl lg:text-5xl leading-8 mb-2 '>International Coffee Roasters</h1>
      ...
      <div className='relative w-full h-[12.6rem] bg-yellow-800/90 lg:bg-transparent'>
        ...
        />
        <div className='absolute z-10 top-6 md:top-24 left-4 md:left-14 flex flex-col text-white/60'>
