...
const Signup = () => {
  return (
    <form className='flex flex-col w-full p-4 bg-yellow-900/60'>
      ...
      <div className='flrx flex-col md:flex-row space-y-3'>
        <div className='flex flex-col'>
          ...
          <input type='text' name='first-name' className='rounded' required />
        </div>
        <div className='flex flex-col'>
          <label htmlFor='last-name'>Last Name</label>
          <input type='text' name='last-name' className='rounded' required />
        </div>
        <div className='flex flex-col'>
          <label htmlFor='email'>Email</label>
          <input type='email' name='email' className='rounded' required />
        </div>
